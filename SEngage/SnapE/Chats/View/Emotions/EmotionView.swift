...
class EmotionView: UIView , UIScrollViewDelegate{
    ...
    override init(frame: CGRect) {
        ...
        let emojiCount = EmotionManager.shareInstance.emotionArray.count
    ...
    func emojiClick(button: UIButton) {
        ...
        if button.tag == 0 {
            ...
            let currentEmoji = EmotionManager.shareInstance.emotionArray[button.tag - 1] as! NSArray
...
class EmojiView: UIView {
    ...
    var parent: EmotionView!
    var buttonSelector: Selector!
    
    convenience init(frame: CGRect,index: Int, parentView: EmotionView, selector: Selector) {
    ...
    func setupEmotionWith(index: Int) {
        ...
        let emotionCount = EmotionManager.shareInstance.emotionArray.count
