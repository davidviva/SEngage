...
class PublicStrings{
    class var SERVER_IP: String {
        // 135.55.22.156   135.55.22.184  135.55.22.67  dlaswovap02.nonprod.avaya.com  placsvmap01.avaya.com
        return "placsvmap01.avaya.com"//"dlaswovap02.nonprod.avaya.com"//"135.55.32.234";
    }
    
    class var HTTP_SERVER_PREFIX : String {
        return "https://" + SERVER_IP+":8080/";
    }
    class var USERNAME_TOOSHORT : String {
        return "The username is too short";
    }
    class var PASSWORD_TOOSHORT : String {
