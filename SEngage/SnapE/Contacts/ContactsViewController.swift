...
//        log.info("floatViewTapItemIndex:\(type)")
        ...
        case .CreateTeams:
            ...
            let teamDetailTableViewController = TeamDetailTableViewController()
            self.navigationController?.pushViewController(teamDetailTableViewController, animated: true)
